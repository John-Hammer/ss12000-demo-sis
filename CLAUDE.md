...
|-------|--------|-------------|
| `minimal` (default) | `minimal_data.py` | Hand-curated KISS dataset: 2 classes (7A 30 students year 7 mentored by Sara Lindqvist, 8A 15 students year 8 mentored by Erik Sandberg), 5 teachers, 1 kurator, 1 rektor, 1 admin, 83 guardians, 7 teaching groups + activities (8A has only SV8/MA8, taught cross-wise so both main personas teach students they don't mentor). Deterministic uuid5 IDs; the skolSköld demo personas (setup_demo_users) reference staff 1001/1002/1006/1007 by UUID |
